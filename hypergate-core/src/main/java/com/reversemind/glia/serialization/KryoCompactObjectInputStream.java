...
public class KryoCompactObjectInputStream extends ObjectInputStream {
    ...
    KryoCompactObjectInputStream(InputStream in, ClassResolver classResolver) throws IOException {
        super(in);
    ...
    protected ObjectStreamClass readClassDescriptor()
        ...
        switch (type) {
            case KryoCompactObjectOutputStream.TYPE_FAT_DESCRIPTOR:
                return super.readClassDescriptor();
            case KryoCompactObjectOutputStream.TYPE_THIN_DESCRIPTOR:
