 ...
 */
public class KryoObjectDecoderInputStream extends InputStream implements ObjectInput {
     ...
     *           read from
     */
    public KryoObjectDecoderInputStream(InputStream in) {
        this(in, null);
    }
     ...
     *                    serialized object
     */
    public KryoObjectDecoderInputStream(InputStream in, ClassLoader classLoader) {
        this(in, classLoader, KryoSettings.EXPERIMENT_MAX_SIZE);
    }
     ...
     */
    public KryoObjectDecoderInputStream(InputStream in, int maxObjectSize) {
     ...
     *                      a {@link java.io.StreamCorruptedException} will be raised.
     */
    public KryoObjectDecoderInputStream(InputStream in, ClassLoader classLoader, int maxObjectSize) {
        if (in == null) {
    ...
    public Object readObject() throws ClassNotFoundException, IOException {
        ...
        return new KryoCompactObjectInputStream(in, classResolver).readObject();
    }
